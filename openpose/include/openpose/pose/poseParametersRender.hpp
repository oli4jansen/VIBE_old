    ...
    #define POSE_BODY_23_COLORS_RENDER_GPU \
        ...
        255.f,     0.f,   255.f, \
         85.f,     0.f,   255.f, \
          ...
          0.f,   255.f,   255.f
    // BODY_21A
    #define POSE_BODY_21A_PAIRS_RENDER_GPU \
        1,8,   1,2,   1,5,   2,3,   3,4,   5,6,   6,7,   8,9,   9,10,  10,11, 8,12,  12,13, 13,14,  1,0,   0,15, 15,17,  0,16, 16,18, 1,19, 19,20, 2,9, 5,12
    #define POSE_BODY_21A_SCALES_RENDER_GPU 1
    #define POSE_BODY_21A_COLORS_RENDER_GPU \
        255.f,     0.f,    85.f, \
        255.f,     0.f,     0.f, \
        255.f,    85.f,     0.f, \
        255.f,   170.f,     0.f, \
